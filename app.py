...
prompt = st.chat_input('You are researcher a conversation with a person. '
                       'Answer each of the person queries with simple, detailed answers based on facts.'
                       'Answers you give should be friendly and clear.')
